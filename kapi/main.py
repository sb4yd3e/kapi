...
from kapi.exceptions import ParseError, ValidationError
...
def docs(schema):
    ...
    loader = jinja2.PrefixLoader({
        'kapi': jinja2.PackageLoader('kapi', 'templates')
    })
    env = jinja2.Environment(autoescape=True, loader=loader)

    template = env.get_template('kapi/docs/index.html')
    ...
    static_dir = os.path.join(os.path.dirname(kapi.__file__), 'static')
    shutil.copytree(static_dir, os.path.join(directory, 'kapi'))
