...
from kapi import exceptions
from kapi.http import HTMLResponse, JSONResponse, PathParams, Response
from kapi.server.adapters import ASGItoWSGIAdapter
from kapi.server.asgi import (
    ASGI_COMPONENTS, ASGIReceive, ASGIScope, ASGISend
)
from kapi.server.components import Component, ReturnValue
from kapi.server.core import Route, generate_document
from kapi.server.injector import ASyncInjector, Injector
from kapi.server.router import Router
from kapi.server.staticfiles import ASyncStaticFiles, StaticFiles
from kapi.server.templates import Templates
from kapi.server.validation import VALIDATION_COMPONENTS
from kapi.server.wsgi import (
...
class App():
    ...
    def include_extra_routes(self, schema_url=None, docs_url=None, static_url=None):
        ...
        from kapi.server.handlers import serve_documentation, serve_schema, serve_static_wsgi
...
class ASyncApp(App):
    ...
    def include_extra_routes(self, schema_url=None, docs_url=None, static_url=None):
        ...
        from kapi.server.handlers import serve_documentation, serve_schema, serve_static_asgi
